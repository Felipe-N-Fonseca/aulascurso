# mudança de caracteristicas do texto
# para o python use a "\" seguido do codigo, o que melhor funciona é o 033
...
# setar cores assim: cores = {'branco':'\033[0;30m', 'azul':'\033[0;34m'}

print('\033[0;30;41m eae rapaziada')
